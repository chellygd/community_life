        ...
        d = {
            select: function() {
                ...
                y = function(i, u, f) {
                    ...
                    if (!u) {
                        ...
                        function() {
                            ...
                            a = e.attr("lay-value"),
                            n = p.attr("lay-filter");
                            var icon=e.attr("layui-icon");
                            t(this).parent().parent().find(".layui-edge-new").remove();
                            t(this).parent().parent().find(".layui-select-title input").attr("style","");
                            if(icon==='undefined'||icon===undefined||icon===null||icon===""){
                            }else{
                            	t(this).parent().parent().find(".layui-select-title input").attr("style","text-indent: 25px;");
                            	t(this).parent().parent().find(".layui-select-title").append("<i class='layui-edge-new layui-icon "+icon+"'></i>");
                            }
                ...
                f.each(function(e, l) {
                    ...
                    m = t(['<div class="' + (h ? "": "layui-unselect ") + a, (u ? " layui-select-disabled": "") + '">', '<div class="' + n + '">', (d==='undefined'||d===undefined||d===null||d===""?'<input type="text" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (h ? "": " readonly") + '  class="layui-input' + (h ? "": " layui-unselect") + (u ? " " + c: "") + '">':'<i class="layui-edge-new layui-icon '+d+'"></i><input type="text" style="text-indent: 25px;" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (h ? "": " readonly") + '  class="layui-input' + (h ? "": " layui-unselect") + (u ? " " + c: "") + '">'), '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group": "") + '">',
                    function(e) {
                        var t = [];
                        return layui.each(e,
                        function(e, a) {
                            0 !== e || a.value ? "optgroup" === a.tagName.toLowerCase() ? t.push("<dt>" + a.label + "</dt>") : t.push(
                            		'<dd lay-value="' + a.value + '" layui-icon="'+a.getAttribute('icon')+'" class="' + (d === a.value ? s: "") + (a.disabled ? " " + c: "") + '">'+(typeof a.getAttribute('icon') === 'undefined' || typeof a.getAttribute('icon') === null ? '' : '<i class="layui-icon '+a.getAttribute('icon')+'" style="margin-right: 5px;"></i>') + a.innerHTML + "</dd>"
                            		) : t.push('<dd lay-value="" class="layui-select-tips">'+(typeof a.getAttribute('icon') === 'undefined' || typeof a.getAttribute('icon') === null ? '' : '<i class="layui-icon '+a.getAttribute('icon')+'" style="margin-right: 5px;"></i>') + (a.innerHTML || i) + "</dd>")
                        }),
